...
| HSE crystal 25 MHz (X1, C9006 = YXC X322525MOB4SI, **CL 12 pF**, ±10 ppm; C41/C42 18 pF discretes -> CL_eff = 9 pF + ~3 pF stray = 12 pF, correct — closes the 2026-08-07 EE review footnote) | PH0 / PH1 | 25 / 26 | OSC_IN / OSC_OUT — firmware clocks 25/M5×N160/P2 = **400 MHz** at VOS1, LDO supply; USB runs on HSI48+CRS so enumeration is crystal-independent |
